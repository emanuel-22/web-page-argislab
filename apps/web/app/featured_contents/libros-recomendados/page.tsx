...
export default function LibrosRecomendadosPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 py-20 sm:px-8">
      ...
      <header className="mx-auto mt-8 flex max-w-3xl flex-col gap-6 text-center">
      ...
      <figure className="mx-auto mt-12 flex max-w-2xl flex-col items-center gap-3 rounded-2xl border bg-card px-6 py-8 text-center">
      ...
      <section className="mt-16">
        <h2 className="text-xl font-black tracking-tight">Explorar por categoría</h2>
