export type Presentation = {
  /** Solo para Prezi: id del embed. */
  id?: string;
  title: string;
  href: string;
  /** Preview de la presentación. Si falta, se muestra un placeholder con la plataforma. */
  image?: string;
  category: string;
  description: string;
  /** Plataforma donde está publicada. */
  platform?: 'Prezi' | 'Google Slides';
};

const PREVIEW = (hash: string) => `https://0701.static.prezi.com/preview/v2/${hash}_3_0.png`;

// Presentaciones publicadas en Prezi (https://prezi.com/user/4mhgnteqpbib/) y otras plataformas.
export const PRESENTATIONS: Presentation[] = [
  {
    ...
    image: '/presentations/prompt-engineering-ia-generativa.webp',
  ...
  },
  {
    ...
    href: 'https://docs.google.com/presentation/d/1hVaCQSrSAFPqMAOSyQuuJQnZlI6H37XJ/edit?usp=sharing&ouid=102991556250859948978&rtpof=true&sd=true',
    image: '/presentations/mas-rapidos-pero-mas-agiles.webp',
    category: 'Agilidad, Kanban y mejora continua',
    platform: 'Google Slides',
    description:
      'Charla del Agile Lean Virtual Lab: la diferencia entre ir más rápido y ser realmente ágil. Acelerar la entrega no alcanza si no mejoramos la capacidad de adaptarnos, aprender y entregar valor.',
  },
  {
    id: 'ayypmffqyc7j',
